...
const steps = [
  {
    ...
    description: '$X is available in BSC, Binance Smart Chain networks. Choose your network from here BSC “DROP DOWN MENU” “Same as in toolbar” to participate in $X pre-sale',
  },
  {
  ...
  },
  {
    ...
    description: 'You can currently swap BNB to $X on Pre-Sale over X\'s official website! Pre-Sale supports only BEP20 BNB.',
  },
  {
    label: 'Swap BEP20 $BNB to $X',
    description: 'Click Connect Wallet Enter the amount of $BNB you would like to swap for $X. Then click on Swap.',
  },
  {
    label: 'Claim $X',
    description: 'All $X purchased can be claimed at the pre-sale page after the end of the vesting period.',
  },
];
