...
const members = [
  {
    ...
    avatar: kevin,
    linkedin: "",
    bio: "He is a CEO, co-founder of X-Verse",
  },
  {
    name: "Derek Smith",
  ...
  {
    name: "Ajay Jain",
    title: "Web/3D development Manager",
    avatar: ajay,
    linkedin: "",
    bio: "He is a web/3d development manager",
  },
  {
    ...
    <Box sx={{ py: 7, borderTop: 1, borderColor: "grey.100" }}>
      <Container>
        <Box sx={{maxWidth: '500px'}}>
          ...
          >
            Have you met the X Founders Team?
          </Typography>
          <Typography 
            color="text.primary" 
            variant="h4" 
